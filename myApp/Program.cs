...
// Protect whole Admin area (Razor Pages)
...
static async Task SeedRolesAndAdminAsync(WebApplication app)
{
    ...
    const string adminEmail = "admin@myapp.local";
    ...
    if (!await userManager.IsInRoleAsync(adminUser, "Admin"))
    {
        ...
        {
            throw new InvalidOperationException($"Failed to assign Admin role to '{adminEmail}'.");
        }
    }
}
